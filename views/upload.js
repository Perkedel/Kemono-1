      ...
      >
        ...
        <div>
          ...
          <input
            ...
            name="file"
          />
          <small class="subtitle" style="margin-left: 5px;">100MB size limit per file due to Cloudflare restrictions</small>
        </div>
        ${process.env.MASTER_KEY ? `
          <div>
            ...
            <input 
              ...
              required
            >
            <small class="subtitle" style="margin-left: 5px;">Uploading is protected behind tokens. Ask for a token in the <a href="https://t.me/kemonoparty">Telegram.</a></small>
          </div>
        ` : ''}
        <input type="submit"/>
      </form>
