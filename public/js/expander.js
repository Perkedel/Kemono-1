var $ = {};
document.documentElement.classList ? ($.hasClass = function (e, t) { return e.classList.contains(t); }, $.addClass = function (e, t) { e.classList.add(t); }, $.removeClass = function (e, t) { e.classList.remove(t); }) : ($.hasClass = function (e, t) { return (' ' + e.className + ' ').indexOf(' ' + t + ' ') != -1; }), $.docEl = document.documentElement;
...
ImageExpansion.checkLoadStart = function (e, t) { if (!e.naturalWidth) return setTimeout(ImageExpansion.checkLoadStart, 15, e, t); ImageExpansion.onLoadStart(e, t), t.style.opacity = ''; };
...
var Main = {};
Main.init = function () { document.addEventListener('DOMContentLoaded', Main.run, !1); };

Main.run = function () { document.addEventListener('click', Main.onclick, !1); };

Main.onclick = function (e) { if ((t = e.target) !== document) { if ($.hasClass(t.parentNode, 'fileThumb')) return void (ImageExpansion.toggle(t) && e.preventDefault()); } };
